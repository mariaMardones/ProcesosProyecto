...
public class IntegrationTest {
    ...
    void testCrearUsuarioCocheYReserva() {
        ...
        try {
            userResponse = restTemplate.postForEntity("/usuario/registrar", usuario, Usuario.class);
        ...
        ResponseEntity<Reserva> reservaResponse = restTemplate.postForEntity("/reservas/crear", reserva,
                Reserva.class);
        ...
        ResponseEntity<Reserva[]> reservasGetResponse = restTemplate.getForEntity("/reservas/pendientes", Reserva[].class);
        ...
        restTemplate.delete("/coche/eliminar?matricula=" + cocheId);

        restTemplate.delete("/usuario/eliminar?email=" + usuario.getEmail());



        ResponseEntity<Reserva[]> reservasGetResponsePostDelete = restTemplate.getForEntity("/reservas/pendientes", Reserva[].class);
